...
_asm_inthandler0d: ; 0d interruption happens when an exception is occurred, this specified by x86 archetyecture
		...
		JNE		end_app		; end_app is defined in _asm_hrb_api
		POP		EAX
		POPAD
		POP		DS
		POP		ES
