...
void init_gdtidt(void)
{
	...
	*/
	...
	/*
		int 0x0d will happen when an exception occurs
		it might be caused by an application that tries to access system memory
		we need to terminate such application and return back to console
	*/
